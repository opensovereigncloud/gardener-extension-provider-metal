...
import (
	...
	healthcheckconfigalpha1 "github.com/gardener/gardener/extensions/pkg/apis/config/v1alpha1"
...
func (c *Config) ApplyHealthCheckConfig(config *healthcheckconfigalpha1.HealthCheckConfig) {
