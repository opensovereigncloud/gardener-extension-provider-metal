...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AddressesFromNetworks)(nil), (*metal.AddressesFromNetworks)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AddressesFromNetworks_To_metal_AddressesFromNetworks(a.(*AddressesFromNetworks), b.(*metal.AddressesFromNetworks), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*metal.AddressesFromNetworks)(nil), (*AddressesFromNetworks)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_metal_AddressesFromNetworks_To_v1alpha1_AddressesFromNetworks(a.(*metal.AddressesFromNetworks), b.(*AddressesFromNetworks), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*SubnetRef)(nil), (*metal.SubnetRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SubnetRef_To_metal_SubnetRef(a.(*SubnetRef), b.(*metal.SubnetRef), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*metal.SubnetRef)(nil), (*SubnetRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_metal_SubnetRef_To_v1alpha1_SubnetRef(a.(*metal.SubnetRef), b.(*SubnetRef), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AddressesFromNetworks_To_metal_AddressesFromNetworks(in *AddressesFromNetworks, out *metal.AddressesFromNetworks, s conversion.Scope) error {
	out.Key = in.Key
	out.SubnetRef = (*metal.SubnetRef)(unsafe.Pointer(in.SubnetRef))
	return nil
}

// Convert_v1alpha1_AddressesFromNetworks_To_metal_AddressesFromNetworks is an autogenerated conversion function.
func Convert_v1alpha1_AddressesFromNetworks_To_metal_AddressesFromNetworks(in *AddressesFromNetworks, out *metal.AddressesFromNetworks, s conversion.Scope) error {
	return autoConvert_v1alpha1_AddressesFromNetworks_To_metal_AddressesFromNetworks(in, out, s)
}

func autoConvert_metal_AddressesFromNetworks_To_v1alpha1_AddressesFromNetworks(in *metal.AddressesFromNetworks, out *AddressesFromNetworks, s conversion.Scope) error {
	out.Key = in.Key
	out.SubnetRef = (*SubnetRef)(unsafe.Pointer(in.SubnetRef))
	return nil
}

// Convert_metal_AddressesFromNetworks_To_v1alpha1_AddressesFromNetworks is an autogenerated conversion function.
func Convert_metal_AddressesFromNetworks_To_v1alpha1_AddressesFromNetworks(in *metal.AddressesFromNetworks, out *AddressesFromNetworks, s conversion.Scope) error {
	return autoConvert_metal_AddressesFromNetworks_To_v1alpha1_AddressesFromNetworks(in, out, s)
}
...
func autoConvert_v1alpha1_SubnetRef_To_metal_SubnetRef(in *SubnetRef, out *metal.SubnetRef, s conversion.Scope) error {
	out.Name = in.Name
...
// Convert_v1alpha1_SubnetRef_To_metal_SubnetRef is an autogenerated conversion function.
func Convert_v1alpha1_SubnetRef_To_metal_SubnetRef(in *SubnetRef, out *metal.SubnetRef, s conversion.Scope) error {
	return autoConvert_v1alpha1_SubnetRef_To_metal_SubnetRef(in, out, s)
}

func autoConvert_metal_SubnetRef_To_v1alpha1_SubnetRef(in *metal.SubnetRef, out *SubnetRef, s conversion.Scope) error {
	out.Name = in.Name
	out.APIGroup = in.APIGroup
	out.Kind = in.Kind
	return nil
...
// Convert_metal_SubnetRef_To_v1alpha1_SubnetRef is an autogenerated conversion function.
func Convert_metal_SubnetRef_To_v1alpha1_SubnetRef(in *metal.SubnetRef, out *SubnetRef, s conversion.Scope) error {
	return autoConvert_metal_SubnetRef_To_v1alpha1_SubnetRef(in, out, s)
}
...
func autoConvert_v1alpha1_WorkerConfig_To_metal_WorkerConfig(in *WorkerConfig, out *metal.WorkerConfig, s conversion.Scope) error {
	...
	out.AddressesFromNetworks = *(*[]*metal.AddressesFromNetworks)(unsafe.Pointer(&in.AddressesFromNetworks))
...
func autoConvert_metal_WorkerConfig_To_v1alpha1_WorkerConfig(in *metal.WorkerConfig, out *WorkerConfig, s conversion.Scope) error {
	...
	out.ExtraServerLabels = *(*map[string]string)(unsafe.Pointer(&in.ExtraServerLabels))
	out.AddressesFromNetworks = *(*[]*AddressesFromNetworks)(unsafe.Pointer(&in.AddressesFromNetworks))
	out.MetaData = *(*map[string]string)(unsafe.Pointer(&in.MetaData))
	return nil
}
