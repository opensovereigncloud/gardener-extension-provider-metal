...
func (in *AddressesFromNetworks) DeepCopyInto(out *AddressesFromNetworks) {
	*out = *in
	if in.SubnetRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddressesFromNetworks.
func (in *AddressesFromNetworks) DeepCopy() *AddressesFromNetworks {
	if in == nil {
		return nil
	}
	out := new(AddressesFromNetworks)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkerConfig) DeepCopyInto(out *WorkerConfig) {
	*out = *in
	...
	if in.AddressesFromNetworks != nil {
		in, out := &in.AddressesFromNetworks, &out.AddressesFromNetworks
		*out = make([]*AddressesFromNetworks, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AddressesFromNetworks)
